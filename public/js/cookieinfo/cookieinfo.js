!function(e) {
    ...
    a.prototype = {
        ...
        insert: function() {
            ...
            t.innerHTML = '<div class="cookieinfo-close" style="float:right;display:block;padding:5px 8px 5px 8px;min-width:100px;margin-left:5px;border-top-left-radius:5px;border-top-right-radius:5px;border-bottom-right-radius:5px;border-bottom-left-radius:5px;">' + this.options.closeText + '</div><span style="display:block;padding:5px 0 5px 0;"><span id="cookiemsg">' + this.options.message + '</span> <a><span id="cookiemsglink">' + this.options.linkmsg + '</span></a><img> <a>' + this.options.scriptmsg + '</a></span>',
            this.element = t;
